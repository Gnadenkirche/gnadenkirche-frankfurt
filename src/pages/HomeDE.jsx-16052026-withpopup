...
function Home() {
  ...
  // ================= POPUP STATE =================
//  const [showPopup, setShowPopup] = useState(true); // set to false to disable
	...
	{/* ===== SCROLL ARROWS (CLICKABLE) ===== */}
	  ...
	  {/* Slide 1 */}
          <div className="slide fade">
            <img src={church1} alt="Unsere Gemeinde – Innenansicht" />
          </div>
          {/* Slide 3 */}
          <div className="slide fade">
	  ...
	  {/* Slide 4 */}
          <div className="slide fade">
            <img src={church4} alt="Unsere Gemeinde – Kirchenraum" />
          </div>
	  {/* Slide 5 */}
          <div className="slide fade">
            <img src={church5} alt="Unsere Gemeinde – Blick in den Kirchenraum" />
          </div>
	  {/* Slide 6 */}
          <div className="slide fade">
            <img src={church6} alt="Unsere Gemeinde – Gottesdienst im Kirchenraum" />
          </div>
