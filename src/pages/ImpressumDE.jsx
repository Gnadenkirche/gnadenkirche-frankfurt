  ...
  return (
    <section className="impressum-section">
      <div className="impressum-content">
        ...
        <p>
          Alternativ können Sie uns über das Kontaktformular auf unserer Website
          erreichen.
        </p>
        ...
        <p>
          ...
          Informationen (Server-Logfiles) erfasst. Diese beinhalten u.a. den
          verwendeten Webbrowser, das Betriebssystem sowie den Internet Service
          Provider. Diese Daten lassen keinerlei Rückschlüsse auf Ihre Person zu.
        </p>

        <p>
          Die Nutzung unserer Webseite ist grundsätzlich ohne Angabe
          personenbezogener Daten möglich. Personenbezogene Daten werden nur auf
          freiwilliger Basis erhoben und nicht ohne ausdrückliche Zustimmung an
        ...
        <p>
          Die Nutzung der im Rahmen der Impressumspflicht veröffentlichten
          Kontaktdaten durch Dritte zur Übersendung von nicht ausdrücklich
          angeforderter Werbung wird hiermit ausdrücklich untersagt.
        </p>
      </div>
    </section>
  );
